            ...
            <React.Fragment key={step.id}>
              ...
              <div className="relative group z-10 flex flex-col items-center">
                <motion.div
                  ...
                  className="w-20 h-20 rounded-full bg-navy-800 border-2 border-white/10 flex items-center justify-center group-hover:border-blue-500 group-hover:shadow-[0_0_20px_rgba(59,130,246,0.3)] transition-all duration-300"
                >
                  <step.icon
                    size={28}
              ...
              {index < steps.length - 1 && (
                <div className="md:hidden relative mx-auto w-px h-14 bg-white/10">
                  {/* Animated energy dot */}
                  <motion.div
                    className="absolute left-1/2 -translate-x-1/2 w-2.5 h-2.5 rounded-full bg-blue-500
