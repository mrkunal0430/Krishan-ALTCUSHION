...
import { Shield, CheckCircle, Award, Lock, Server, Users, Globe } from 'lucide-react';
...
const trustMetrics = [
  ...
  { id: 4, label: 'Global Compliance', value: 12, suffix: ' Stds', icon: Globe },
];

const certifications = ['ISO 27001', 'SOC 2 Type II', 'GDPR Compliant', 'HIPAA Ready'];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            >
               ...
               <span className="text-green-400 text-xs font-mono uppercase tracking-widest">Trust Protocol: ACTIVE</span>
            </motion.div>
            ...
            <p className="text-slate-400 text-lg mb-8 leading-relaxed max-w-xl">
              We operate with the rigor of a financial institution and the agility of a startup. Our platform is built on a foundation of verifiable security, global compliance, and transparent performance.
            </p>
            ...
            <div className="flex flex-wrap gap-4">
               {certifications.map((cert, i) => (
                 <motion.div 
                   ...
                   className="flex items-center space-x-2 px-4 py-2 bg-white/5 border border-white/10 rounded-lg hover:bg-white/10 transition-colors cursor-default"
                 >
                    <CheckCircle size={16} className="text-green-500" />
                    <span className="text-sm font-mono text-slate-300">{cert}</span>
                 </motion.div>
               ))}
            </div>
          </div>
          ...
          <div className="relative">
             <div className="relative bg-navy-900/40 backdrop-blur-xl border border-white/10 rounded-2xl p-8 overflow-hidden">
               {/* Background Grid */}
...
const MetricCard = ({ metric, delay }) => {
  return (
    <motion.div
      ...
      viewport={{ once: true }}
      transition={{ delay }}
      className="bg-navy-950/60 border border-white/5 p-6 rounded-xl relative group hover:border-green-500/30 transition-colors"
    >
