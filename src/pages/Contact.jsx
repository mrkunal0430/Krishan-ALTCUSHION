        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          <div>
            ...
            <p className="text-xl text-slate-400 mb-12">
              Ready to secure your infrastructure and scale your operations?
              Reach out to our global team of architects today.
            </p>
                  ...
                  {step === 3 && (
                    ...
                    >
                      ...
                      <p className="text-slate-400 mb-8">
                        Thank you for reaching out. One of our architects will
                        analyze your request and get back to you within 24
                        hours.
                      </p>
