            ...
            <div className="absolute inset-x-0 top-12 bottom-12 bg-navy-900/40 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-2xl flex flex-col overflow-hidden ring-1 ring-white/5">
              ...
              <div className="grid grid-cols-2 gap-4 flex-1">
                ...
                <div className="bg-black/20 rounded-lg p-4 border border-white/5 relative overflow-hidden group">
                  ...
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <span className="text-[10px] text-green-400 border border-green-500/30 px-1.5 py-0.5 rounded bg-green-500/10">
                      SECURE
                    </span>
                  </div>
                ...
                <div className="bg-black/20 rounded-lg p-4 border border-white/5 relative overflow-hidden group">
                  ...
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <span className="text-[10px] text-blue-400 border border-blue-500/30 px-1.5 py-0.5 rounded bg-blue-500/10">
                      GLOBAL
                    </span>
                  </div>
                  <div className="text-2xl font-bold text-white mb-1">
                ...
                <div className="col-span-2 bg-black/40 rounded-lg p-4 border border-white/5 font-mono text-[10px] text-slate-400 overflow-hidden relative">
                  ...
                  <div className="space-y-1.5">
                    <div className="flex space-x-2">
                      <span className="text-slate-600">12:45:01</span>{" "}
                      <span className="text-green-400">SUCCESS</span>{" "}
                      <span>Connection established to Server A1</span>
                    </div>
                    <div className="flex space-x-2">
                      <span className="text-slate-600">12:45:03</span>{" "}
                      <span className="text-blue-400">INFO</span>{" "}
                      <span>Scanning protocols initiated...</span>
                    </div>
                    <div className="flex space-x-2">
                      <span className="text-slate-600">12:45:10</span>{" "}
                      <span className="text-primary-400">UPDATE</span>{" "}
                      <span>Firewall rules updated</span>
                    </div>
                    <div className="flex space-x-2">
                      <span className="text-slate-600">12:45:12</span>{" "}
                      <span className="text-green-400">SUCCESS</span>{" "}
                      <span>Encryption handshake complete</span>
                    </div>
                    <div className="flex space-x-2">
                      <span className="text-slate-600">12:45:15</span>{" "}
                      <span className="text-blue-400">INFO</span>{" "}
                      <span>Optimizing user traffic route</span>
                    </div>
                    <div className="flex space-x-2">
                      <span className="text-slate-600">12:45:18</span>{" "}
                      <span className="text-green-400">SUCCESS</span>{" "}
              ...
              <div className="mt-4 pt-4 border-t border-white/5 flex justify-between items-center">
                <div className="flex -space-x-2">
                  ...
                  <div className="w-8 h-8 rounded-full bg-slate-500 border-2 border-navy-900 flex items-center justify-center text-[10px] font-bold text-white">
                    +4
                  </div>
                </div>
