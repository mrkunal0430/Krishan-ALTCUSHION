...
export const servicesData = [
  ...
  },
  {
    ...
    process: [
      { number: '01', title: 'Map', desc: 'Identifying high-impact automation opportunities.' },
      { number: '02', title: 'Train', desc: 'Fine-tuning AI models on your data.' },
      { number: '03', title: 'Integrate', desc: 'Embedding AI agents into workflows.' },
  ...
  },
  {
    ...
    process: [
      { number: '01', title: 'Analyze', desc: 'Deep dive into business model and skill gaps.' },
      { number: '02', title: 'Strategize', desc: 'Developing tailored roadmap and training curriculum.' },
      { number: '03', title: 'Execute', desc: 'Hands-on implementation and interactive workshops.' },
      { number: '04', title: 'Optimize', desc: 'Continuous refinement and skill validation.' }
    ]
  },
  {
  ...
  },
  {
    ...
    shortDescription: 'End-to-end development services for web, mobile, and cloud applications with enterprise-grade architecture and user-centric design.',
    ...
    process: [
      ...
      { number: '03', title: 'Test', desc: 'Rigorous QA for bugs, security, and performance.' },
      { number: '04', title: 'Deploy', desc: 'CI/CD pipeline for seamless production launch.' }
    ]
  },
  {
    id: 'erp-solutions',
    ...
    shortDescription: 'Streamline operations with comprehensive ERP systems covering finance, inventory, HR, CRM, and supply chain management.',
    fullDescription: 'Transform your business operations with our highly customizable, AI-enhanced Enterprise Resource Planning (ERP) platform. Designed for seamless innovation and scalability, our ERP solutions integrate all core business processes into a unified system. From manufacturing to healthcare, construction to retail, we provide industry-specific modules that eliminate silos, automate workflows, and provide real-time business intelligence for strategic decision-making.',
    icon: Database,
    ...
    process: [
      { number: '01', title: 'Discovery', desc: 'Understanding business processes and requirements.' },
      { number: '02', title: 'Design', desc: 'Configuring modules and customizing workflows.' },
      { number: '03', title: 'Implement', desc: 'Data migration, testing, and user training.' },
      { number: '04', title: 'Support', desc: 'Ongoing optimization and feature enhancements.' }
    ]
  },
  {
    id: 'it-consulting',
    ...
    shortDescription: 'Expert guidance for cloud infrastructure, IT modernization, and technology strategy with fractional CTO/CIO expertise.',
